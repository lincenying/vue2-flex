                    ...
                    <el-form label-width="220px">
                        <el-form-item label="flex-direction">
                            <el-select v-model="flexDirection">
                                <el-option v-for="(item, index) in options1" :label="item.value" :value="item.value" :key="index"> </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="flex-wrap">
                            <el-select v-model="flexWrap">
                                <el-option v-for="(item, index) in options2" :label="item.value" :value="item.value" :key="index"> </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="justify-content">
                            <el-select v-model="justifyContent">
                                <el-option v-for="(item, index) in options3" :label="item.value" :value="item.value" :key="index"> </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="align-items">
                            <el-select v-model="alignItems">
                                <el-option v-for="(item, index) in options4" :label="item.value" :value="item.value" :key="index"> </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="align-content">
                            <el-select v-model="alignContent">
                                <el-option v-for="(item, index) in options5" :label="item.value" :value="item.value" :key="index"> </el-option>
                            </el-select>
                        </el-form-item>
                    </el-form>
                </div>
...
import 'element-theme-chalk/lib/row.css'
import 'element-theme-chalk/lib/col.css'

import elSelect from 'element-ui/lib/select'
import elOption from 'element-ui/lib/option'
import 'element-theme-chalk/lib/select.css'
import 'element-theme-chalk/lib/option.css'

import elForm from 'element-ui/lib/form'
import 'element-theme-chalk/lib/form.css'
import elFormItem from 'element-ui/lib/form-item'
import 'element-theme-chalk/lib/form-item.css'
